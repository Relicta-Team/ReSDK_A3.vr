...
regScriptEmit(SLIGHT_LEGACY_CANDLE)
	[
		"lt",
		[["randomize_value_vec3",["setLightColor",[ [0.7,0.65,0.4],[1,0.65,0.5] ], [.1,.1],true]],["randomize_value_vec3",["setLightAmbient",[ [0.18,0.05,0],[0.2,0.05,0] ], [.1,.1], true]],["randomize_value_float",["setLightIntensity",[16,20.25],[.1,.1], true]]],
		_emitAlias("Свет")
		["linkToSrc",[0,0,0.07]],
