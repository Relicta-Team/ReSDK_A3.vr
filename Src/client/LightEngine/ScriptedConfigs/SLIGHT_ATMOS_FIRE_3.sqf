...
regScriptEmit(SLIGHT_ATMOS_FIRE_3)
	[
		"pt",
	...
	,[
		...
		["linkToLight",[0,0,0]],
		["setParticleParams",[["\A3\data_f\ParticleEffects\Universal\Refract.p3d",1,0,1,0],"","Billboard",1,0.45,[0,0,0],[0,0,0],1,0.8,1,0.1,[2.8,1.5],[[0.3,0.3,0.3,0.01],[0.3,0.3,0.3,0.26],[0.3,0.3,0.3,0.24],[0.3,0.3,0.3,0.22],[0.3,0.3,0.3,0.16],[0.3,0.3,0.3,0.08],[0.3,0.3,0.3,0.02]],[2,1],0.1,0.05,"","","",0,false,-1,[]]],
	...
	,[
		"pt",
		[["loop_sound",["fire\flame_3",[0.9,1.1],15,2]]],
		_emitAlias("Пламя")
		["linkToLight",[0,0,0]],
	...
	,[
		...
		["linkToLight",[0,0,0.3]],
		["setLightColor",[0.08,0.04,0]],
		["setLightAmbient",[0.03,0.01,0]],
		["setLightIntensity",6754.07],
		["setLightAttenuation",[0.3,0,0,0,1,5]]
	]
endScriptEmit