...
"
	...
	in:int:Количество костей. По умолчанию 1.
		opt:def=1
"
...
"
	...
	in:int:Значение
		opt:def=1
	in:struct.RollResult:Результат
"
...
"
	...
	desc:Бросает три 6-гранных кости против значения. Возвращает успешность действия или неудачу.
	in:int:Значение
		opt:def=1
