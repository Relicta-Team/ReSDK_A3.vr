...
class(RBrigadirSaloon) extends(BasicRoleSaloon)
	...
	var(desc,"Бывший бригадир"+comma+" превративший заброшенный завод Злачника в Ломню"+comma+"
ныне единственный"+comma+" кто остался из бывшего руководства предприятия. 
Только на Ломне есть стабильная работа в Злачнике для работяг.
Поддерживай дисциплину"+comma+" не подводи работяг - обеспечь их работой и плати вовремя.");
	var(count,1);
