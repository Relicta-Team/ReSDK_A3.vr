...
// дробящий (cr) причиняет ущерб через обычный тупой удар, например дубинкой.
#define DAMAGE_TYPE_CRUSHING "dt_crushing"
// взрывная волна: высокоэнергетическая тупая травма с внутренними повреждениями
#define DAMAGE_TYPE_BLAST "dt_blast"
// режущий
...
#define DAMAGE_TYPE_LIST_NODE_BINDING [ "Дробящий:"+DAMAGE_TYPE_CRUSHING+":Ущерб через обычный тупой удар, например дубинкой." \
