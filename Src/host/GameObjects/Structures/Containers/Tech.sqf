...
class(MerchantConsole) extends(ElectronicDevice)
	...
	regItemDef(MC_CAT_CLOTH,"WorkerCap",5,9,3,6)
	regItemDef(MC_CAT_CLOTH,"HatOldUshanka",5,9,3,5)
	regItemDef(MC_CAT_CLOTH,"WoolCoat",8,12,5,7)
	regItem(MC_CAT_CLOTH,"CitizenCloth1","CitizenCloth"+str randInt(1,22),10,14,3,10)

	regItemDef(MC_CAT_OTHER,"PaperHolder",10,15,2,7)
	regItemDef(MC_CAT_OTHER,"PenBlack",5,8,5,12)
	...
	regItemDef(MC_CAT_OTHER,"BrushCleaner",2,8,4,15)

	regItemDef(MC_CAT_LIGHT,"TorchDisabled",6,10,5,10)
	regItemDef(MC_CAT_LIGHT,"CandleDisabled",3,5,10,20)
	regItemDef(MC_CAT_LIGHT,"LampKeroseneDisabled",8,12,3,8)
	regItemDef(MC_CAT_LIGHT,"CampfireCreator",8,12,3,8)
	regItemDef(MC_CAT_LIGHT,"MatchBox",5,10,4,6)
	...
	regItemDef(MC_CAT_WEAPONS,"Trap",10,20,1,4)
	...
	regItemDef(MC_CAT_FOOD,"SigaretteDisabled",4,7,15,30)
