...
["createObject","Создать объект",'new(@in.1)',"classname:Имя класса","object^:Объект:Созданный объект","Выполняет базовое создание объекта. Если вам нужно создать игровой объект используйте узел для создания игровых объектов"] reg_unary
["deleteObject","Удалить объект",'delete(@in.1)',"object^:Объект:Ссылка на объект","","Выполняет базовое удаление объекта. Обратите внимание, что для удаления игровых объектов необходимо использовать узел для удаления игровых объектов."] reg_unary
