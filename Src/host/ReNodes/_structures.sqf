...
["SpawnPoint",[
    "enum.SpawnPointType:Тип спавна::Тип точки спавна"
...
["SpawnLocationConnection",[
    "enum.SpawnLocationConnectionType:Тип привязки::Тип поиска объекта для привязки персонажа. Если указан тип привязки ""Не определено"" - привязка не будет выполнена.",
...
["SkillDef",
    [
        "enum.SkillType:Тип навыка::Тип навыка для выдачи персонажу.",
...
"name:Условие запуска"] node_struct
