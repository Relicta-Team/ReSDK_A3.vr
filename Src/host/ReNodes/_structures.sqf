...
["SpawnPoint",[
    "enum.SpawnPointType:Тип спавна:'-1':Тип точки спавна",
...
["SpawnLocationConnection",[
    "enum.SpawnLocationConnectionType:Тип привязки:'-1':Тип поиска объекта для привязки персонажа. Если указан тип привязки ""Не определено"" - привязка не будет выполнена.",
...
["SkillDef",
    [
        "enum.SkillType:Тип навыка:'-1':Тип навыка для выдачи персонажу.",
