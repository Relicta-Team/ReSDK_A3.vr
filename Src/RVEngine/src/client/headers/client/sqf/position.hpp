...
namespace intercept {
    namespace sqf {
        ...
        struct rv_bounding_box {
            ...
            /**
                                                               * @brief Constructs a bounding box from a game_value.
                                                               *
                                                               * Initializes the bounding box fields from the provided game_value array:
                                                               * `gv_[0]` -> `min`, `gv_[1]` -> `max`, `gv_[2]` -> `bounding_radius`.
                                                               *
                                                               * @param gv_ game_value containing [min, max, bounding_radius] in that order.
                                                               */
