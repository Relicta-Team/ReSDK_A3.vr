...
namespace intercept {
    namespace sqf {
        struct rv_remote_target_info {
            ...
            float last_detected;
            /**
                   * @brief Constructs an rv_remote_target_info from a game_value tuple.
                   *
                   * Initializes members from gv_ where index 0 is the target object and index 1 is the last-detected time in seconds.
                   *
                   * @param gv_ game_value array-like with two elements: [0] target object, [1] last_detected (float).
                   */
        ...
        struct rv_named_properties {
            ...
            sqf_string value;
            /**
                   * @brief Constructs an rv_named_properties instance from a game_value containing a property name and its value.
                   *
                   * @param gv_ A game_value array-like container where index 0 is the property name and index 1 is the property value; both are converted to `sqf_string`.
                   */
        ...
        struct rv_pylon_info {
            ...
            /**
                   * @brief Construct an rv_pylon_info from a game_value tuple.
                   *
                   * Expects `gv_` to be an array-like game_value with fields in the following order:
                   * 0: pylon index (numeric),
                   * 1: pylon name (string),
                   * 2: assigned turret path (rv_turret_path-compatible value),
                   * 3: magazine classname (string),
                   * 4: magazine ammo count/detail (string),
                   * 5: additional magazine detail (string).
                   *
                   * @param gv_ game_value containing the pylon information in the layout described above.
                   */
        ...
        struct rv_lod_info {
            ...
            float count_named_selections;  /**
                   * @brief Initializes an rv_lod_info from a game_value tuple describing a model LOD.
                   *
                   * @param gv_ game_value array with elements in this order:
                   *             0: LOD index,
                   *             1: LOD name,
                   *             2: LOD resolution,
                   *             3: number of named selections in this LOD.
                   */
        ...
        struct rv_crew_member {
            ...
            /**
                 * @brief Constructs an rv_crew_member from a game_value tuple.
                 *
                 * Initializes a crew member's fields from an ordered game_value containing:
                 * [unit, role, cargo_index, turret_path, person_turret].
                 *
                 * @param gv_ game_value array where
                 *            - element 0: unit (object),
                 *            - element 1: role (string),
                 *            - element 2: cargo index (number),
                 *            - element 3: turret path (rv_turret_path-compatible value),
                 *            - element 4: person turret flag (bool).
                 */
            ...
            /**
                   * @brief Constructs an rv_crew_member from explicit member values.
                   *
                   * @param unit_ The crew unit object.
                   * @param role_ The role name for the crew member (e.g., "driver", "gunner").
                   * @param cargo_index_ The cargo seat index occupied by the unit.
                   * @param turret_path_ The turret path identifying the turret position within the vehicle.
                   * @param person_turret_ `true` if the turret is occupied by a person rather than being remote/automated, `false` otherwise.
                   */
        ...
        struct rv_cruise_params {
            ...
            bool auto_thrust{};
            /**
                 * @brief Constructs cruise control parameters from a SQF game_value.
                 *
                 * Interprets gv_ as a two-element sequence where element 0 is the cruise
                 * speed and element 1 is the auto-thrust flag.
                 *
                 * @param gv_ game_value with layout: [speed, auto_thrust]
                 */
        ...
        struct rv_periscope_state {
            ...
            bool is_locked{};
            /**
                 * @brief Initialize a periscope state from a SQF `game_value`.
                 *
                 * @param gv_ A `game_value` where element 0 is the periscope elevation and element 1 is the lock state. 
                 */
        ...
        struct rv_vehicle_sensor {
            ...
            bool is_enabled{};
            /**
                 * @brief Constructs an rv_vehicle_sensor from a GameValue representation.
                 *
                 * Initializes the sensor_name and is_enabled members from a two-element GameValue.
                 *
                 * @param gv_ GameValue expected to be an array-like value where:
                 *             - gv_[0] is the sensor name (string)
                 *             - gv_[1] is the enabled flag (boolean)
                 */
        ...
        struct rv_info_panel {
            ...
            /**
                   * @brief Constructs an rv_info_panel from a game_value tuple.
                   *
                   * @param gv_ A game_value containing two elements: class name and component type
                   *            which initialize `class_name` and `component_type` respectively.
                   */
        ...
        struct rv_info_panel_component {
            ...
            bool is_accessible{};
            /**
                 * @brief Construct an rv_info_panel_component from a packed game_value.
                 *
                 * @param gv_ A game_value with three elements in order: class name (string), component type (string), and accessibility (bool).
                 */
        ...
        struct rv_sensor_target {
            ...
            sqf_string sensor;
            /**
                   * @brief Constructs an rv_sensor_target from a game_value tuple.
                   *
                   * @param gv_ game_value containing exactly four elements in order:
                   *            0 — target object,
                   *            1 — type (string),
        ...
        struct rv_sensor_threat {
            ...
            sqf_string sensor;
            /**
                   * @brief Constructs an rv_sensor_threat from a game_value.
                   *
                   * Initializes members from a 3-element game_value interpreted as [target, type, sensor].
                   *
                   * @param gv_ game_value with elements: 0 = target object, 1 = threat type string, 2 = sensor name string.
                   */
        ...
        struct rv_collision_status {
            ...
            bool mutual;
            /**
 * @brief Construct an rv_collision_status from a game_value tuple.
 *
 * Initializes members from `gv_` where element 0 is the associated object
 * and element 1 is the mutual collision flag.
 *
 * @param gv_ A game_value sequence: [object, mutual_flag].
 */
explicit rv_collision_status(const game_value &gv_) : obj(gv_[0]), mutual(gv_[1]) {}
        ...
        struct rv_entity_info {
			...
			bool is_set_for_deletion;           /**
                   * @brief Constructs an rv_entity_info from a game_value containing ordered entity state fields.
                   *
                   * @param gv_ game_value array with fields in the following order:
                   * 0: is_man,
                   * 1: is_animal,
                   * 2: is_dead_set,
                   * 3: dead_set_time,
                   * 4: last_entity_causing_damage,
                   * 5: last_damage_time,
                   * 6: is_upside_down,
                   * 7: upside_down_time,
                   * 8: is_stopped,
                   * 9: can_float,
                   * 10: has_terminal_opened,
                   * 11: is_weaponholder,
                   * 12: is_wreck,
                   * 13: is_smoking,
                   * 14: is_set_for_deletion
                   */
        ...
        struct rv_vehicle_respawn_info {
            ...
            bool is_respawning;              /**
                                                                       * @brief Initializes an rv_vehicle_respawn_info from a SQF game_value tuple.
                                                                       *
                                                                       * Constructs a respawn info instance by extracting fields from `gv_` in the order expected from the SQF API.
                                                                       *
                                                                       * @param gv_ Game value tuple where elements map as:
                                                                       *  - [0] respawn_delay
                                                                       *  - [1] respawn_count
                                                                       *  - [2] delete_old_wreck
                                                                       *  - [3] respawn_on_server
                                                                       ...
                                                                       *  - [6] respawn_mode
                                                                       *  - [7] respawn_side
                                                                       *  - [8] use_respawn_marker_dir
                                                                       *  - [9] can_respawn
                                                                       *  - [10] is_respawning
                                                                       *  - [11] respawn_marker_name
                                                                       *  - [12] respawn_time_remaining
                                                                       *  - [13] mission_respawn_delay
                                                                       *  - [14] mission_respawn_mode
                                                                       */
        ...
        struct rv_shot_info {
            ...
            bool is_submunition_triggered;  /**
                                                            * @brief Initializes an rv_shot_info from a game_value containing shot state.
                                                            *
                                                            * Maps elements of gv_ to the struct fields in the following order:
                                                            * gv_[0] -> effective_time_to_live,
                                                            * gv_[1] -> fuse_distance_left,
                                                            * gv_[2] -> time_to_explosion,
                                                            * gv_[3] -> trigger_is_forced,
                                                            * gv_[4] -> shown_tracer,
                                                            * gv_[5] -> is_real,
                                                            * gv_[6] -> is_submunition_triggered.
                                                            *
                                                            * @param gv_ Game value array containing the shot information in the order described above.
                                                            */
        ...
        struct rv_disabled_equipment {
            ...
            bool ti;
            /**
                   * @brief Constructs an rv_disabled_equipment from a SQF game_value.
                   *
                   * Interprets the provided `game_value` as a two-element sequence where the first element
                   * is the NVG-disabled flag and the second element is the TI-disabled flag, and initializes
                   * the corresponding members.
                   *
                   * @param gv_ A game_value with format [nvg_disabled, ti_disabled].
                   */
        ...
        struct rv_physics_flags
        {
            bool collision;
            /**
                 * @brief Constructs an rv_physics_flags from a game_value representing physics flags.
                 *
                 * @param gv_ A game_value whose element 0 is the collision flag (interpreted as a boolean).
                 */
        ...
        struct rv_turret_limits {
            ...
            bool overridden;  /**
                   * @brief Initialize turret traversal limits and override flag from a SQF `game_value`.
                   *
                   * Constructs an rv_turret_limits by extracting values from `gv_` in the following order:
                   * 0 = minimum turn, 1 = maximum turn, 2 = minimum elevation, 3 = maximum elevation, 4 = overridden flag.
                   *
                   * @param gv_ A `game_value` array containing five elements in the order described above.
                   */
