...
namespace intercept {
    namespace sqf {
        ...
        struct rv_unit_trait {
            ...
            float value;
            /**
                   * @brief Construct an rv_unit_trait from a game_value.
                   *
                   * Initializes `trait` from element 0 of `gv_` and `value` from element 1.
                   *
                   * @param gv_ A game_value containing at least two elements: a trait name at index 0 and a numeric trait value at index 1.
                   */
        ...
        struct rv_expected_destination {
            ...
            /**
                                                                          * @brief Constructs an rv_expected_destination from a raw game_value returned by the engine.
                                                                          *
                                                                          * Interprets the incoming game_value as a tuple where element 0 is the destination position,
                                                                          * element 1 is the planning mode string, and element 2 is the force-replan flag.
                                                                          *
                                                                          * @param ret_game_value_ Engine-produced game_value containing [position, planning_mode, force_replan].
                                                                          */
        ...
        struct rv_unload_in_combat {
            ...
            bool allow_turrets;
            /**
                   * @brief Constructs an rv_unload_in_combat from a game_value.
                   *
                   * @param gv_ A game_value containing two elements: element 0 denotes whether cargo unloading is allowed, element 1 denotes whether turret unloading is allowed. Each element is interpreted as a boolean-like value.
                   */
