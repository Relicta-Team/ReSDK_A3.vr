...
namespace intercept {
    namespace sqf {
        struct rv_apperture_params {
            ...
            bool custom_forced{};      /**
                   * @brief Initializes aperture parameters from a game_value array.
                   *
                   * Parses the provided `game_value` (array-like) and assigns its elements to the struct fields using the following index mapping:
                   * - [0] current_aperture
                   * - [1] forced
                   * - [2] approx_aperture
                   * - [3] approx_luminance
                   ...
                   * - [9] light_intensity
                   *
                   * @param gv_ Array-like `game_value` containing at least 10 elements in the order documented above.
                   */
        ...
        struct rv_pp_effect {
            ...
            /**
             * @brief Converts this post-processing effect into a game_value representation.
             *
             * The resulting game_value is an array with two entries: the effect name and its priority.
             *
             * @return game_value An array-equivalent `game_value` containing `[name, priority]`.
             */
            operator game_value() {
             ...
             * @brief Converts this post-processing effect into a game_value representation.
             *
             * Produces a game_value containing an array with two elements: the effect name and its priority.
             *
             * @return game_value A game_value array in the form `[name, priority]`.
             */
        ...
        struct rv_camera_target {
            ...
            /**
                   * @brief Constructs an rv_camera_target from a game_value representation.
                   *
                   * Initializes the struct fields from gv_, which is expected to be an array in the
                   * order: is_tracking, target_position, target_object.
                   *
                   * @param gv_ Game value array containing [is_tracking, target_position, target_object].
                   */
