...
namespace intercept {
    namespace sqf {
        ...
        struct rv_channel_info {
            ...
            bool exists;
            /**
             * @brief Construct an rv_channel_info by extracting fields from a game_value array.
             *
             * Extracts channel metadata from the provided game_value array where:
             * - index 0: colour
             * - index 1: label
             * - index 2: call sign
             * - index 3: array of unit objects (copied into `units`)
             * - index 4: protocol flag
             * - index 5: existence flag
             *
             * @param gv_ A game_value containing the channel data arranged as described above.
             */
