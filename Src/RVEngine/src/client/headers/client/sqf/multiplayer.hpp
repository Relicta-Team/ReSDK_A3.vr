...
namespace intercept {
    namespace sqf {
        struct rv_user_info {
            ...
            float desync;                   // 9 - 2
            bool is_headless;               /**
                                                            * @brief Construct an rv_user_info from a game_value array containing user data.
                                                            *
                                                            * The input `gv_` is expected to be an indexed array with the following layout:
                                                            * - [0] player ID (string)
                                                            * - [1] owner (float)
                                                            * - [2] player UID (string)
                                                            * - [3] soldier name (string)
                                                            * - [4] display name (string)
                                                            * - [5] Steam profile name (string)
                                                            * - [6] client state (float)
                                                            * - [7] headless flag (bool)
                                                            * - [8] admin state (float)
                                                            * - [9] ping/bandwidth/desync array: [0]=avg_ping (float), [1]=avg_bandwidth (float), [2]=desync (float)
                                                            * - [10] player object (object)
                                                            *
                                                            * @param gv_ Indexed game_value array containing user information as described above.
                                                            */
