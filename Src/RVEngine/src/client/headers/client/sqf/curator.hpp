...
namespace intercept {
    namespace sqf {
        ...
        struct curator_selected_return {
            /**
                 * @brief Constructs a curator_selected_return by taking ownership of provided selection vectors.
                 *
                 * @param _objs Vector of selected objects.
                 * @param _g Vector of selected groups.
                 * @param _wps Vector of selected waypoints.
                 * @param _m Vector of selected markers.
                 */
        ...
        struct rv_curator_cam_area {
            ...
            float radius;
            /**
                   * @brief Construct an rv_curator_cam_area from a game_value containing [id, position, radius].
                   *
                   * Initializes cam_area_id, pos, and radius from the provided game_value array:
                   * element 0 -> camera area id, element 1 -> position (vector3), element 2 -> radius.
                   *
                   * @param gv_ game_value array with three elements: id, position, and radius.
                   */
