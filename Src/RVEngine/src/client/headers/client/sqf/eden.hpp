...
namespace intercept {
    namespace sqf {
        ...
        struct rv_eden_mouse_over {
            std::string type;
            game_value entity;/**
                   * @brief Constructs an rv_eden_mouse_over from a two-element game_value representing the editor mouse-over state.
                   *
                   * @param rv_game_value_ A two-element `game_value` where the first element is a string type (e.g., "Object", "Group", "Trigger", "Logic", "Waypoint", or "Marker")
                   *                       and the second element is the corresponding entity value.
                   */
