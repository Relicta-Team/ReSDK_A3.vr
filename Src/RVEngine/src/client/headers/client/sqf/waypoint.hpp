...
namespace intercept {
    namespace sqf {
        ...
        public:
            ...
            /**
                   * @brief Constructs a waypoint from a group and a waypoint index.
                   *
                   * @param rv_game_value Group that owns the waypoint.
                   * @param windex Waypoint index (stored internally as a float).
                   */
            ...
            /**
                   * @brief Constructs a waypoint from a game_value representation.
                   *
                   * Expects `from_` to be an array-like game_value containing two elements:
                   * the first is a group and the second is the waypoint index.
                   *
                   * @param from_ Game value holding [group, index] used to initialize the waypoint.
                   */
            ...
            /**
             * @brief Serialize the waypoint into the engine's array representation.
             *
             * @return game_value A two-element game_value where element 0 is the waypoint's group and element 1 is the waypoint's index.
             */
            ...
            /**
             * @brief Convert a textual speed identifier into the matching speed constant.
             *
             * @param subject_ Exact string to parse (must match one of the internal speed lookup entries).
             * @return waypoint::speed The `waypoint::speed` value that corresponds to `subject_`.
             * @throws int Throws `712` when `subject_` does not match any known speed identifier.
             */
            ...
            /**
             * @brief Parse a show-mode string into the corresponding waypoint show enum.
             *
             * @param subject_ String token representing a show mode (case-sensitive).
             * @return show Enum value that corresponds to the provided string.
             * @throws int Throws integer 712 if the input does not match any known show string.
             */
            ...
            /**
             * @brief Parse a waypoint type name into the corresponding waypoint::type enum value.
             *
             * @param subject_ The exact string name of the waypoint type to parse.
             * @return waypoint::type The enum value that corresponds to the given string.
             * @throws int Throws integer 712 when the input string does not match any known type.
             */
            ...
            /**
             * @brief Parse a behaviour name string into its corresponding enum value.
             *
             * Converts a string matching one of the known behaviour lookup entries into the
             * corresponding waypoint::behaviour enum value.
             *
             * @param subject_ String to parse (case-sensitive, must match an entry in the behaviour lookup).
             * @return behaviour The matching behaviour enum value.
             * @throws int 712 if the provided string does not match any known behaviour.
             */
            ...
            /**
             * @brief Parse a combat mode name string to the corresponding combat_mode enumerator.
             *
             * @param subject_ The input string identifying a combat mode (case-sensitive).
             * @return combat_mode The matching combat mode enumerator.
             * @throws int Throws integer 712 when the input does not match any known combat mode.
             */
            ...
            /**
             * @brief Parses a formation name string into the corresponding waypoint::formation enum value.
             *
             * @param subject_ Formation name to parse; compared case-sensitively against the known formation lookup strings.
             * @return waypoint::formation The enum value that corresponds to `subject_`.
             * @throws int Throws `712` if `subject_` does not match any known formation string.
             */
            ...
            /**
             * @brief Parse a string into a waypoint loiter type enum.
             *
             * Converts a textual representation of a loiter type to the corresponding
             * waypoint::loiter_type enum value.
             *
             * @param subject_ String to parse (case-sensitive match against known loiter types).
             * @return waypoint::loiter_type The matching enum value.
             * @throws int 712 if the input does not match any known loiter type.
             */
            ...
            /**
             * @brief Returns the string representation for a waypoint speed enum value.
             *
             * @param subject_ The waypoint `speed` enum value to convert.
             * @return std::string_view The corresponding string view from the internal lookup table.
             */
            static std::string_view __get_enum_as_str(speed subject_) {
                return __speed_lookup[static_cast<int>(subject_)];
            }
            /**
             * @brief Get the textual name for a waypoint show enum value.
             *
             * @param subject_ The `waypoint::show` enum value to convert.
             * @return std::string_view The corresponding string view from the show lookup table.
             */
            static std::string_view __get_enum_as_str(show subject_) {
                return __show_lookup[static_cast<int>(subject_)];
            }
            /**
             * @brief Get the string representation for a waypoint `type` enum value.
             *
             * @param subject_ Waypoint `type` enum to convert to its string representation.
             * @return std::string_view The string view from the internal lookup table corresponding to `subject_`.
             */
            static std::string_view __get_enum_as_str(type subject_) {
                return __type_lookup[static_cast<int>(subject_)];
            }
            /**
             * @brief Get the textual name for a waypoint behaviour enum value.
             *
             * @param subject_ Waypoint behaviour enum value to convert.
             * @return std::string_view The corresponding string view from the internal behaviour lookup array.
             */
            static std::string_view __get_enum_as_str(behaviour subject_) {
                return __behaviour_lookup[static_cast<int>(subject_)];
            }
            /**
             * @brief Get the string name for a combat_mode enum value.
             *
             * @param subject_ The combat_mode value to map to its textual representation.
             * @return std::string_view The lookup string corresponding to the provided `combat_mode`.
             */
            static std::string_view __get_enum_as_str(combat_mode subject_) {
                return __combat_mode_lookup[static_cast<int>(subject_)];
            }
            /**
             * @brief Get the string view corresponding to a waypoint formation enum value.
             *
             * @param subject_ The formation enum value to convert.
             * @return std::string_view The formation name as a string view.
             */
            static std::string_view __get_enum_as_str(formation subject_) {
                return __formation_lookup[static_cast<int>(subject_)];
            }
            /**
             * @brief Get the string representation of a loiter_type value.
             *
             * @param subject_ The loiter_type value to convert.
             * @return std::string_view String view of the corresponding loiter type name from the internal lookup table.
             */
        ...
        */
        ...
        struct rv_waypoint_statements {
            ...
            /**
             * @brief Constructs rv_waypoint_statements from a game value array.
             *
             * Initializes `condition` and `statement` from the first and second elements
             * of `gv_`, respectively.
             *
             * @param gv_ Game value array where element 0 is the condition string and
             * element 1 is the statement string.
             */
        ...
        struct rv_waypoint_timeout {
            float min, mid, max;
            /**
                 * @brief Constructs an rv_waypoint_timeout from a game_value containing timeout components.
                 *
                 * Extracts the minimum, middle, and maximum timeout values from the provided game_value and
                 * stores them in the struct's `min`, `mid`, and `max` members respectively.
                 *
                 * @param gv_ A game_value array where element 0 is the minimum timeout, element 1 is the middle timeout,
                 *            and element 2 is the maximum timeout.
                 */
        ...
        */
        ...
        struct rv_trigger_activation {
            ...
            bool repeating;
            /**
                   * @brief Constructs an rv_trigger_activation from a game_value array.
                   *
                   * Expects gv_ to be an array with three elements: activated-by string at index 0,
                   * activation-type string at index 1, and a boolean repeating flag at index 2.
                   *
                   * @param gv_ Game value array containing [activated_by, activation_type, repeating].
                   */
        ...
        struct rv_trigger_statements {
            ...
            /**
                   * @brief Construct an rv_trigger_statements from a game_value array.
                   *
                   * Extracts the first three elements of gv_ and assigns them to
                   * `condition`, `on_activation`, and `on_deactivation` respectively.
                   *
                   * @param gv_ game_value array in the form [condition, on_activation, on_deactivation].
                   */
        ...
        struct rv_trigger_area {
            ...
            bool rectangle;
            float z;  /**
                                                                  * @brief Construct an rv_trigger_area from a game_value array.
                                                                  *
                                                                  * Initializes the struct fields from the supplied game_value where the
                                                                  * elements correspond to trigger area properties in the following order:
                                                                  * index 0 = x, index 1 = y, index 2 = angle, index 3 = rectangle, index 4 = z.
                                                                  *
                                                                  * @param ret_game_value_ game_value array containing the trigger area components in the order above.
                                                                  *
        ...
        struct rv_trigger_timeout {
            ...
            /**
                                                                     * @brief Constructs an rv_trigger_timeout from a game_value array.
                                                                     *
                                                                     * Initializes timeout fields by extracting elements from `ret_game_value_` in the following order:
                                                                     * time_min, time_mid, time_max, interruptable.
                                                                     *
                                                                     * @param ret_game_value_ A game_value array with four elements: minimum time, middle time, maximum time, and an interruptable flag.
                                                                     */
