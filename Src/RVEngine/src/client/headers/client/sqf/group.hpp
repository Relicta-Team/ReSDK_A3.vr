...
namespace intercept {
    namespace sqf {
        ...
        struct rv_group_icon_params {
            ...
            /**
                                                                                * @brief Constructs group icon parameters from a game_value containing ordered fields.
                                                                                *
                                                                                * @param ret_game_value_ Array-like game_value with elements in order:
                                                                                *                         index 0 = color,
                                                                                *                         index 1 = text,
                                                                                *                         index 2 = scale,
                                                                                *                         index 3 = visible (boolean).
                                                                                */
