...
namespace intercept {
    namespace sqf {
        struct rv_mod_info {
            ...
            bool isOfficial{};
            /**
                   * @brief Constructs rv_mod_info from a game_value array representing mod metadata.
                   *
                   * Initializes members by reading specific indices from the provided `game_value` array:
                   * index 0 = `modname`, 1 = `modDir`, 2 = `isDefault`, 3 = `isOfficial`,
                   * 4 = `origin`, 5 = `hash`, 6 = `hashShort`, 7 = `itemID`.
                   *
                   * @param gv_ Array-like `game_value` containing mod information in the order described above.
                   */
        ...
        struct rv_friend_servers {
            ...
            sqf_string name{};
            /**
                   * @brief Construct an rv_friend_servers entry from a game_value array.
                   *
                   * Initializes the struct's ip_address and name from the provided `game_value` where index 0 is the IP address and index 1 is the server name.
                   *
                   * @param gv_ Array-like `game_value` expected to contain at least two elements: [0] IP address, [1] server name.
                   */
        ...
        struct rv_addon_info {
            ...
            bool is_patched{};
            /**
                   * @brief Constructs rv_addon_info from a game_value array representing addon metadata.
                   *
                   * @param gv_ Array-like `game_value` where:
                   *            - index 0: prefix (string)
                   *            - index 1: version_str (string)
                   *            - index 2: is_patched (bool)
                   *            - index 3: mod_index (int)
                   *            - index 4: hash (string)
                   */
        ...
        struct rv_dlc_usage_stats {
            ...
            float totalTime{};
            /**
                   * @brief Constructs rv_dlc_usage_stats from a game_value array.
                   *
                   * Initializes members from the provided game_value where
                   * index 0 => name, 1 => dlcAppId, 2 => sessionTime, 3 => totalTime.
                   *
                   * @param gv_ Array-like game_value containing the DLC usage fields in the order above.
                   */
        ...
        struct rv_dlc_asset_info {
            ...
            bool isInstalled;           //
            bool isAvailable;           /**
                   * @brief Construct an rv_dlc_asset_info from a game_value array.
                   *
                   * Interprets the provided game_value as an array and initializes members using
                   ...
                   * - [5] -> DLCName
                   *
                   * @param gv_ Array-like game_value containing at least six elements in the order described above.
                   */
        ...
        struct rv_event_handler_info {
            ...
            int total;
            /**
             * @brief Initialize event handler query results from a game_value array.
             *
             * Reads indices 0–2 of gv_ and maps them to the struct fields:
             * index 0 => exists, index 1 => is_last, index 2 => total.
             *
             * @param gv_ Array-like game_value containing [exists, is_last, total].
             */
