...
namespace intercept {
    namespace sqf {
        ...
        struct rv_artillery_computer_settings {
            ...
            sqf_string ammo;
            int mode;  /**
                   * @brief Construct an artillery computer settings object from a game_value sequence.
                   *
                   * Initializes members by reading a sequence where index 0 is the artillery computer name,
                   * index 1 is the ammunition type, and index 2 is the mode.
                   *
                   * @param rv_game_value_ A game_value sequence with at least three elements: [name, ammo, mode].
                   */
        ...
        struct rv_credit {
            ...
            /**
                   * @brief Initializes rv_credit from a two-element game_value sequence.
                   *
                   * Extracts index 0 as the library name and index 1 as the credits and assigns them to members.
                   *
                   * @param rv_game_value_ Game value sequence where element 0 is the library name and element 1 is the credits.
                   */
        ...
        struct rv_product_version {
            ...
            /**
                   * @brief Constructs an rv_product_version from a game_value sequence.
                   *
                   * @param rv_game_value_ Sequence expected to contain [name, name_short, version, build, branch, mods, platform] at indices 0..6 respectively.
                   */
