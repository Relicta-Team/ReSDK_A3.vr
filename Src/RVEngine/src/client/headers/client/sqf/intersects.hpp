...
namespace intercept {
    namespace sqf {
        ...
        struct intersect_result {
            ...
            /**
                   * @brief Constructs an intersect_result from a game value representation.
                   *
                   * Initializes `selection_name` from gv_[0] and `intersect_distance` from gv_[1].
                   *
                   * @param gv_ Game value expected to be an indexable container where:
                   *            - gv_[0] is the selection name (string).
                   *            - gv_[1] is the intersection distance (float).
                   */
