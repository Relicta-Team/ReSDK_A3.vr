...
namespace intercept {
    namespace sqf {
        struct rv_forces_rtd {
            /**
 * @brief Construct an rv_forces_rtd from a game_value containing rotor force components.
 *
 * @param gv_ Game value with three numeric elements: roll at index 0, pitch at index 1, and collective at index 2.
 */
explicit rv_forces_rtd(game_value gv_) : roll(gv_[0]), pitch(gv_[1]), collective(gv_[2]) {}
        ...
        struct rv_weight_rtd {
            ...
            /**
             * @brief Construct an rv_weight_rtd with explicit component values.
             *
             * Initializes the weight components for a rotorcraft RTD weight record.
             *
             * @param fuselage_ Weight of the fuselage component.
             * @param crew_ Weight of the crew component.
             * @param fuel_ Weight of the fuel component.
             * @param custom_ Weight of any custom payload component.
             * @param weapons_ Weight of the weapons component.
             */
            ...
            /**
             * @brief Constructs an rv_weight_rtd from a length-5 float vector.
             *
             * Expects the input vector to contain five elements in the following order:
             * index 0 = fuselage, 1 = crew, 2 = fuel, 3 = custom, 4 = weapons.
             *
             * @param weight_vector_ Vector of five floats representing weight components.
             * @return rv_weight_rtd Instance populated from the vector elements.
             */
