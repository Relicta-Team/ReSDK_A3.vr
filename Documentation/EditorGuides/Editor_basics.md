...
| Опция	| Описание |
| ---- | ---- |
|Системные инструменты|Здесь хранятся инструменты платформы, такие как консоль отладки, просмотрщик анимаций и конфигов. По умолчанию данный раздел выключен и включается через настройки ReEditor.
