...
- A visible blast applies only the sight-gated DynamicBlur afterimage, which decays smoothly over at most twenty seconds without periodic pulses or chromatic aberration. No black or dark-adaptation overlay is created.
...
- Client tests: particle creation without script errors, explosion audibility at measured distances, tinnitus and low-pass decay, voice muffling, sight-gated afterimage recovery without cycling or darkening, one-off ten-metre camera shake with 2.5-to-1 centre/edge strength, absence of grenade-owned chromatic aberration, and repeated explosions.
